...
def get_user_profile(user_id: int, db: Session = Depends(get_db)):
    """
    Fetch a user's pronunciation profile and compute dynamic
    weak/strong phoneme performance from phoneme_performance table.
    """

    # -------------------------------------------------------
    # 1. Fetch main profile row
    # -------------------------------------------------------
    profile = (
    ...
    # -------------------------------------------------------
    # 2. Fetch phoneme performance rows for this user
    # -------------------------------------------------------
    phoneme_stats = (
