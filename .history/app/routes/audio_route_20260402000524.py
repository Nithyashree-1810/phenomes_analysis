...
from app.repo.phoneme_performance_repo import get_or_create_phoneme_performance

router = APIRouter(prefix="/test", tags=["pronunciation"])
service = PronunciationQuestionsService()
from app.repo.user_pronunciation_profile_repo import get_or_create_user_profile

profile = get_or_create_user_profile(db, user_id=user_id)
