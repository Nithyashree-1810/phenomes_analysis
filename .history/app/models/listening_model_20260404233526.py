"""
app/models/listening_model.py
ORM model for listening exercise attempts.

BUG FIXED:
- created_at used datetime.utcnow (naive) but the column had no timezone.
  Changed to server_default=func.now() with timezone=True for consistency.
"""
