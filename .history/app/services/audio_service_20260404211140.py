...
#
# KEY FIX vs original:
#   FFmpeg path was hardcoded to a Windows desktop path.
#   Now read from FFMPEG_PATH env var — works on any machine / CI / prod.
#   Add to your .env:  FFMPEG_PATH=C:\Users\fidel\Desktop\FFmpeg\bin\ffmpeg.exe
#   On Linux/Mac just leave it unset — pydub finds ffmpeg on PATH automatically.
