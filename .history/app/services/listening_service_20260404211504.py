...
#   1. gpt-3.5-turbo → gpt-4o-mini (gpt-3.5-turbo deprecated)
#   2. Removed duplicate OpenAI() client — now imports shared client
#   3. max_tokens reduced (400 → 200 for questions, 200 → 150 for passage)
#   4. Fixed prompt template: use str.format() instead of fragile .replace()
#   5. Fixed: {difficulty} placeholder was never substituted in original
