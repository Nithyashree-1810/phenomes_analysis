...
Transcribes audio using local OpenAI Whisper (open-source, free).
Falls back to gpt-4o-transcribe API if local Whisper is unavailable.

WHY LOCAL WHISPER:
- Zero cost (no API charges)
- Audio never leaves your server (privacy)
- No internet dependency
- Accuracy on par with API for clean speech (use large-v3 model)
