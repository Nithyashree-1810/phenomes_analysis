...
Optimized pronunciation scoring pipeline.

CHANGES vs previous version:
1. gpt_extract_ipa     → replaced with espeak-ng (subprocess) with epitran fallback
2. gpt_extract_mistakes → replaced with difflib (stdlib, zero cost)
3. gpt_generate_tips   → kept as GPT-4o-mini (only LLM call remaining, ~240 tokens/call)
"""
import json
import logging
import re
