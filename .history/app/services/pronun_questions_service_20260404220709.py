...
Generates pronunciation practice sentences using GPT-4o-mini via LangChain.

BUGS FIXED vs original:
- qb_agent.py imported `generate_pronunciation_questions` from this module
  but the function was named `PronunciationQuestionsService.generate_questions`
  (a method, not a module-level function).  Added a module-level function
  alias so both callers work.
- Bare `except:` replaced with `except Exception` + logging.
"""
import json
import logging
import re
